package com.xzit.sysauthorization.oauth2custom.provider;

import cn.hutool.core.util.ReflectUtil;
import com.xzit.sysauthorization.oauth2custom.custom.PasswordAuthenticationToken;
import com.xzit.sysauthorization.utils.OAuth2AuthenticationProviderUtils;
...
public class PasswordAuthenticationProvider implements AuthenticationProvider {
    private static final String ERROR_URI = "http://127.0.0.1:9999/error";
